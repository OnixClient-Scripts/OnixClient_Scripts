name = "More Keystrokes numpad version"
...
function render(deltaTime)
    ...
    gfx.text(8,8,keytostr(keybind1))
    --key2
    gfx.color(background.r,background.g,background.b,background.a)
    gfx.rect(23,0,22,22)
    ...
    gfx.rect(23,0,22,22)
    gfx.color(text.r,text.g,text.b,text.a)
    gfx.text(31,8,keytostr(keybind2))
    --key3
    gfx.color(background.r,background.g,background.b,background.a)
    gfx.rect(46,0,22,22)
    ...
    gfx.rect(46,0,22,22)
    gfx.color(text.r,text.g,text.b,text.a)
    gfx.text(54,8,keytostr(keybind3))
    --key4
    gfx.color(background.r,background.g,background.b,background.a)
    gfx.rect(0,23,22,22)
